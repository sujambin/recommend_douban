package com.demo.doubanApi.proxy2;
...
public class HttpsUtils {
    ...
    public static void main(String[] args) {
        ...
        String getResult = HttpsUtils.sendGet(url, params, proxySet, proxyHost, proxyPort);
     ...
     * @return 响应结果
     */
    public static String sendGet(String url, String param, boolean isproxy, String host, int port) {
        String result = "";
